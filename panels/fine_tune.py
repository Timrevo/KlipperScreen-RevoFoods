...
class Panel(ScreenPanel):
    ...
    def __init__(self, screen, title):
        ...
        self.labels['z+'] = self._gtk.Button("z-farther", "Z+", "arrows")
        self.labels['z-'] = self._gtk.Button("z-closer", "Z-", "arrows")
        self.labels['zoffset'] = self._gtk.Button("refresh", '  0.00' + _("mm"),
                                                  "arrows", self.bts, Gtk.PositionType.LEFT, 1)
        self.labels['speed+'] = self._gtk.Button("speed+", _("Speed +"), "setting_blue3")
        self.labels['speed-'] = self._gtk.Button("speed-", _("Speed -"), "setting_blue3")
        self.labels['speedfactor'] = self._gtk.Button("refresh", "  100%",
                                                      "setting_blue3", self.bts, Gtk.PositionType.LEFT, 1)

        self.labels['extrude+'] = self._gtk.Button("flow+", _("Extrusion +"), "blue_move")
        self.labels['extrude-'] = self._gtk.Button("flow-", _("Extrusion -"), "blue_move")
        self.labels['extrudefactor'] = self._gtk.Button("refresh", "  100%",
                                                        "blue_move", self.bts, Gtk.PositionType.LEFT, 1)
